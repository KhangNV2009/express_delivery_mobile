...
class DeliveryUnconfirmedWidget extends GetView<MainDriverController> {
  @override
  ...
  Widget _buildDeliveries() {
    return Expanded(
      child: RefreshIndicator(
        onRefresh: () async {
          controller.getDeliveriesUnconfirmed();
        },
        child: AnimationLimiter(
          child: Obx(
            () => ListView.builder(
              itemCount: controller.unconfirmedDeliveries.length,
              itemBuilder: (BuildContext context, int index) {
                final delivery = controller.unconfirmedDeliveries[index];
