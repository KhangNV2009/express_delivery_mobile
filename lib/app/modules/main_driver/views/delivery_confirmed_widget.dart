...
class DeliveryConfirmedWidget extends GetView<MainDriverController> {
  @override
  ...
  Widget _buildDeliveries() {
    return Expanded(
      child: RefreshIndicator(
        onRefresh: () async {
          controller.getDeliveriesConfirmed();
        },
        child: AnimationLimiter(
          child: Obx(
            () => ListView.builder(
              itemCount: controller.confirmedDeliveries.length,
              itemBuilder: (BuildContext context, int index) {
                final delivery = controller.confirmedDeliveries[index];
